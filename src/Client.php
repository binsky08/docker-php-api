...
class Client extends \Docker\API\Runtime\Client\Client
{
    ...
    */
    public function containerCreate(?\Docker\API\Model\ContainersCreatePostBody $requestBody = null, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    *
    * @return null|\Docker\API\Model\ContainersIdTopGetJsonResponse200|\Psr\Http\Message\ResponseInterface
    */
    ...
    */
    public function containerUpdate(string $id, ?\Docker\API\Model\ContainersIdUpdatePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function putContainerArchive(string $id, $requestBody = null, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
    ...
    */
    public function systemAuth(?\Docker\API\Model\AuthConfig $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
     ...
     */
    public function imageCommit(?\Docker\API\Model\ContainerConfig $requestBody = null, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     *
     * @return null|\Docker\API\Model\SystemDfGetJsonResponse200|\Psr\Http\Message\ResponseInterface
     */
    public function systemDataUsage(string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
    ...
    */
     ...
     * @return null|\Docker\API\Model\IdResponse|\Psr\Http\Message\ResponseInterface
     */
    public function containerExec(string $id, ?\Docker\API\Model\ContainersIdExecPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     * 
     *
     * @param null|\Docker\API\Model\VolumesCreatePostBody $requestBody 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function volumeCreate(?\Docker\API\Model\VolumesCreatePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     */
    public function networkCreate(?\Docker\API\Model\NetworksCreatePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function networkConnect(string $id, ?\Docker\API\Model\NetworksIdConnectPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function networkDisconnect(string $id, ?\Docker\API\Model\NetworksIdDisconnectPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
    ...
    *
    * @return null|\Docker\API\Model\PluginsPrivilegesGetJsonResponse200Item[]|\Psr\Http\Message\ResponseInterface
    */
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function pluginDisable(string $name, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function nodeUpdate(string $id, ?\Docker\API\Model\NodeSpec $requestBody = null, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function swarmInit(?\Docker\API\Model\SwarmInitPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function swarmJoin(?\Docker\API\Model\SwarmJoinPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function swarmUpdate(?\Docker\API\Model\SwarmSpec $requestBody = null, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
     ...
     *
     * @return null|\Docker\API\Model\SwarmUnlockkeyGetJsonResponse200|\Psr\Http\Message\ResponseInterface
     */
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function swarmUnlock(?\Docker\API\Model\SwarmUnlockPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
    public function serviceCreate(?\Docker\API\Model\ServicesCreatePostBody $requestBody = null, array $headerParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
    public function serviceUpdate(string $id, ?\Docker\API\Model\ServicesIdUpdatePostBody $requestBody = null, array $queryParameters = array(), array $headerParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     * @return null|\Docker\API\Model\IdResponse|\Psr\Http\Message\ResponseInterface
     */
    public function secretCreate(?\Docker\API\Model\SecretsCreatePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function secretUpdate(string $id, ?\Docker\API\Model\SecretSpec $requestBody = null, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
    ...
    */
     ...
     * @return null|\Docker\API\Model\IdResponse|\Psr\Http\Message\ResponseInterface
     */
    public function configCreate(?\Docker\API\Model\ConfigsCreatePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function configUpdate(string $id, ?\Docker\API\Model\ConfigSpec $requestBody = null, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
