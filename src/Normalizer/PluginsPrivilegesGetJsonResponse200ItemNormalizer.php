...
class PluginsPrivilegesGetJsonResponse200ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\API\\Model\\PluginsPrivilegesGetJsonResponse200Item';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Docker\\API\\Model\\PluginsPrivilegesGetJsonResponse200Item';
    }
    /**
     * @return mixed
     */
